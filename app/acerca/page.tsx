    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-4">Calmoté en Números</h2>
              <p className="text-lg text-muted-foreground">
                Casi un siglo de crecimiento y compromiso con el sabor local.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">Comunidades Asociadas</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">Regiones de Origen</div>
              </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-4">Nuestro Equipo</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Los expertos apasionados que hacen posible la experiencia Calmoté.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center border-border/50">
                <CardContent className="p-6">
                  <img
                    src="/professional-portrait-of-elegant-woman-tea-master-.jpg"
                    alt="Catalina Schmidt"
                    className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                  />
                  <h3 className="font-serif text-xl font-semibold text-foreground mb-2">Catalina Schmidt</h3>
                  <p className="text-primary font-medium mb-3">Maestra de Té y Fundadora</p>
                  <p className="text-muted-foreground text-sm">
                    Cuarta generación de la familia, Catalina honra el legado de su bisabuela Amalia, innovando con
                    nuevas mezclas.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-border/50">
                <CardContent className="p-6">
                  <img
                    src="/professional-portrait-of-distinguished-man-tea-exp.jpg"
                    alt="Benjamín Soto"
                    className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                  />
                  <h3 className="font-serif text-xl font-semibold text-foreground mb-2">Benjamín Soto</h3>
                  <p className="text-primary font-medium mb-3">Director de Orígenes</p>
                  <p className="text-muted-foreground text-sm">
                    Con 20 años recorriendo Chile, Benjamín conecta con las comunidades que nos proveen los
                    ingredientes más puros.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-border/50">
                <CardContent className="p-6">
                  <img
                    src="/professional-portrait-of-young-woman-tea-sommelier.jpg"
                    alt="Isidora Rojas"
                    className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                  />
                  <h3 className="font-serif text-xl font-semibold text-foreground mb-2">Isidora Rojas</h3>
                  <p className="text-primary font-medium mb-3">Sommelier de Infusiones</p>
                  <p className="text-muted-foreground text-sm">
                    Especialista en crear experiencias sensoriales, Isidora es la artista detrás de nuestras mezclas
                    más queridas.
                  </p>
                </CardContent>
              </Card>
